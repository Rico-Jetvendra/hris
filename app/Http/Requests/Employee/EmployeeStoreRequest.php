...
class EmployeeStoreRequest extends FormRequest{
    ...
    public function rules(){
        return [
            ...
            'employee.employee_ktp'        => 'nullable|string|max:16',
            'employee.employee_blood'      => 'nullable|integer',
            'employee.employee_religion'   => 'nullable|integer',
            'employee.employee_marriage'   => 'nullable|integer',
